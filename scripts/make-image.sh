...
$path/third-party/echfs/echfs-utils -m -p0 $path/navy.img import $(dirname $0)/limine.cfg boot/limine.cfg 
$path/third-party/echfs/echfs-utils -m -p0 $path/navy.img import $path/kernel.elf boot/kernel.elf 
$path/third-party/echfs/echfs-utils -m -p0 $path/navy.img import $path/third-party/limine/stage2.map boot/stage2.map
